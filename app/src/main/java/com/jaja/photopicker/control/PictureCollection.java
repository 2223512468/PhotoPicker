 ...
 */
package com.jaja.photopicker.control;
...
import com.jaja.photopicker.adapter.PictureAdapter;
import com.jaja.photopicker.loader.PictureLoader;
...
public class PictureCollection implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final String ARGS_ALBUM = BundleUtils.buildKey(PictureCollection.class,
            "ARGS_ALBUM");
